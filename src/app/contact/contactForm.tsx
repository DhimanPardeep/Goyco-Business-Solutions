...
const ZOHO_HIDDEN_FIELDS = {
  xnQsjsdp: "698b5bbd5cb02d33daee783ac87a8a8624ef19f11717e95528b09e077dbb35fe",
  zc_gad: "",
  xmIwtLD:
    "71e99b1d0db2d27b796ecaa15dee3fbec8fa05aa943cf97c29593686787f294071621b70ea74c836284122e29ceda82b",
  actionType: "Q3VzdG9tTW9kdWxlMjM=",
  returnURL: "null",
};
...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    formData.append("COBJ23CF3", form.companyName);
    formData.append("COBJ23CF4", form.firstName);
    formData.append("COBJ23CF5", form.lastName);
    formData.append("COBJ23CF1", form.contactNo);
    formData.append("Email", form.email);
    formData.append("Secondary Email", form.secondaryEmail);
    formData.append("COBJ23CF2", form.message);
